...
world.beforeEvents.worldInitialize.subscribe(data => {
    data.itemComponentRegistry.registerCustomComponent("poke_horn:copper_horn", new PokeCopperHorns());
    data.itemComponentRegistry.registerCustomComponent("poke_horn:goat_horn", new PokeGoatHorn());
});
